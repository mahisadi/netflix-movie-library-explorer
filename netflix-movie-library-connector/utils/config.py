...
if google_drive_cred_json:
    try:
        ...
        logger.error("Error: google_drive_cred_json parsing error")
GOOGLE_DRIVE_PERMISSION_SCOPE=os.environ.get('GOOGLE_DRIVE_PERMISSION_SCOPE')
GOOGLE_DRIVE_AUTH_FLOW_REDIRECT_URI=os.environ.get('GOOGLE_DRIVE_AUTH_FLOW_REDIRECT_URI')
# Redis Configuration
